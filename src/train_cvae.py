...
from loss import KLLoss, BCELoss, Annealer, GradientPrinting
from callback import MultiLossEarlyStopping
...
def generate_synthetic_data(**kwargs):
    ...
    for i in range(len(hparam_label)):
        ...
        trainer = pl.Trainer(max_epochs=200, # try different values
